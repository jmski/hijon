...
const About = () => {
  return (
    <Container>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 text-stone-400 text-xs">
        ...
        <div>
          ...
          <p>Passionate about building and creating things that help people</p>
        </div>
      </div>
    </Container>
  );
